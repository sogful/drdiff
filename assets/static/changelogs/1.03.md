...
### Chapter 1
- [PSS-only] Fixed an instance where fighting Jevil could occasionally crash the game.

### Chapter 2
- [Switch 2-only] Fixed a softlock in the part where you catch mice in a basket on your head.
- [PSS-only] Fixed a crash in an optional keyboard puzzle.
- [PSS-only] Fixed an occasional crash on the file load screen.
